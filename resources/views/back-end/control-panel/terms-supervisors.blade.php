                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="update-mod btn btn-warning rounded-pill px-2 px-sm-4 "
                                            onclick="window.location.href='{{route('admin.add.role',$row -> id)}}'"
                                    >الصلاحيات
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class=" modal-body mx-auto edit-modal-content" action="{{route('admin.moderators.update')}}"
                          method="POST">
                        @csrf
        ...
        <script>
            ...
            function deleteAlert($id) {
                swal({
                    ...
                    fetch('/admin/moderators/delete/' + $id)
