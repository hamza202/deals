                        ...
                        <div class="card mt-3">
                            <div class="head-card align-items-end d-flex justify-content-end"
                                ...
                                @else
                                    ...
                                    style="background-image: url({{ asset( 'front-end/images/advertising-images/no_image.png') }} );">
                                    @endif
                            ...
                            <div class="mb-2 py-1 button-group py-3 px-1">
                                ...
                                <div class="d-flex justify-content-center">
                                    <button type="button" class="btn btn-outline-info rounded-pill"
                                            data-toggle="modal" type="button" onclick="window.location.href='{{route('admin.advertise', $row ->id)}}'">

                                        <div class="row inside-button px-2">
                                            <p class="my-0 mx-1">تفاصيل الاعلان </p></div>
                                    </button>
                                </div>
                                <button onclick="deleteAlert({{$row -> id}})" type="submit" class="btn btn-outline-info rounded-pill">
                    ...
                    @isset($data)
                        @foreach($data as $row)
                            <tr>
                                ...
                                <td>{{$row -> email}}</td>
                                <td>{{$row -> money}}</td>
                                <td><a href="{{$row -> files}}" download="bank"><i class="fa fa-download" aria-hidden="true"></i></a></td>
                                <td>
                                    <div class="d-flex justify-content-center">

                                        <button type="submit" onclick="window.location.href='{{route('admin.commission.update',$row ->id)}}'"
        ...
        <script>
            function deleteAlert($id) {
                swal({
                    ...
                    fetch('/admin/advertising/delete/'+$id)
