        ...
        <div class="row justify-content-center">
            <div class="content col-12 d-flex justify-content-between align-items-center my-5">
                ...
                <div class="d-flex flex-column px-2">
                    ...
                    <a type="button" href="{{route('admin.add.all.role', ['id' => $data -> id])}}"
                       class="btn btn-info blue-btn the-button my-1 px-4"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group form-check ">
                                        <input type="checkbox" name="{{$row ->code}}" value="1" class="questionCheckBox form-check-input
...
<script>
    function tetstt() {
        document.getElementById("exampleCheck1").classList.add('checked');
