                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            <button
                                class="update-city btn btn-success rounded-pill px-2 px-sm-4 green-btn border-0 ml-2"
                                onclick="window.location.href='{{route('admin.reports.AdvertiserActiveReport')}}'">
                                pdf
                            </button>

                            <button
                                class="update-city btn btn-success rounded-pill px-2 px-sm-4 green-btn border-0 ml-2"
                                onclick="window.location.href='{{route('admin.reports.AdvertiserActiveReportExcel')}}'">
                                Excel
                            </button>
        ...
        <div class="modal-dialog modal-dialog-centered w-75" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form" action="{{route('admin.reports.AdvertiserReport')}}" method="POST">
                        @csrf
        ...
        <div class="modal-dialog modal-dialog-centered w-75" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form" action="{{route('admin.reports.AdvertiserReportExcel')}}" method="POST">
                        @csrf
                        <input type="hidden" value="" id="id" name="id">
                        <input type="hidden" value="" id="name" name="name">
        ...
        <div class="modal-dialog modal-dialog-centered w-75" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form" action="{{route('admin.reports.AdvertiserSocialReport')}}" method="POST">
                        @csrf
                        <input type="hidden" value="" id="id" name="id">
                        <input type="hidden" value="" id="name" name="name">
        ...
        <div class="modal-dialog modal-dialog-centered w-75" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form" action="{{route('admin.reports.AdvertiserSocialReportExcel')}}" method="POST">
                        @csrf
                        <input type="hidden" value="" id="id" name="id">
                        <input type="hidden" value="" id="name" name="name">
        ...
        <div class="modal-dialog modal-dialog-centered w-75" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form" action="{{route('admin.reports.AdvertiserAccountReport')}}" method="POST">
                        @csrf
                        <input type="hidden" value="" id="id" name="id">
                        <input type="hidden" value="" id="name" name="name">
        ...
        <div class="modal-dialog modal-dialog-centered w-75" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form" action="{{route('admin.reports.AdvertiserAccountReportExcel')}}" method="POST">
                        @csrf
                        <input type="hidden" value="" id="id" name="id">
                        <input type="hidden" value="" id="name" name="name">
        ...
        <div class="modal-dialog modal-dialog-centered w-75" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form" action="{{route('admin.reports.VisitorReport')}}" method="POST">
                        @csrf
                        <input type="hidden" value="" id="id" name="id">
                        <input type="hidden" value="" id="name" name="name">
        ...
        <div class="modal-dialog modal-dialog-centered w-75" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form" action="{{route('admin.reports.VisitorReportExcel')}}" method="POST">
                        @csrf
                        <input type="hidden" value="" id="id" name="id">
                        <input type="hidden" value="" id="name" name="name">
        ...
        <div class="modal-dialog modal-dialog-centered w-75" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form" action="{{route('admin.reports.GiftReport')}}" method="POST">
                        @csrf
                        <input type="hidden" value="" id="id" name="id">
                        <input type="hidden" value="" id="name" name="name">
        ...
        <div class="modal-dialog modal-dialog-centered w-75" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form" action="{{route('admin.reports.GiftReportExcel')}}" method="POST">
                        @csrf
                        <input type="hidden" value="" id="id" name="id">
                        <input type="hidden" value="" id="name" name="name">
        ...
        <div class="modal-dialog modal-dialog-centered w-75" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form" action="{{route('admin.reports.MoneyReport')}}" method="POST">
                        @csrf
                        <input type="hidden" value="" id="id" name="id">
                        <input type="hidden" value="" id="name" name="name">
        ...
        <div class="modal-dialog modal-dialog-centered w-75" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form" action="{{route('admin.reports.MoneyReportExcel')}}" method="POST">
                        @csrf
                        <input type="hidden" value="" id="id" name="id">
                        <input type="hidden" value="" id="name" name="name">
        ...
        <div class="modal-dialog modal-dialog-centered w-75" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form" action="{{route('admin.reports.CategoryReport')}}" method="POST">
                        @csrf
                        <input type="hidden" value="" id="id" name="id">
                        <input type="hidden" value="" id="name" name="name">
        ...
        <div class="modal-dialog modal-dialog-centered w-75" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form" action="{{route('admin.reports.CategoryReportExcel')}}" method="POST">
                        @csrf
                        <input type="hidden" value="" id="id" name="id">
                        <input type="hidden" value="" id="name" name="name">
