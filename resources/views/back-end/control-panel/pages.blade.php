                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            <button type="submit"
                                    ...
                                    data-toggle="modal"
                                    onclick="window.location.href='{{route('admin.pages.about_us')}}'"
                            >
                                اعدادات الصفحة
                            </button>
                        </div>
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            <button type="submit"
                                    ...
                                    onclick="window.location.href='{{route('admin.pages.site_treaty')}}'"
                            >
                                اعدادات الصفحة
                            </button>
                        </div>
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            <button type="submit"
                                    class="update-city btn btn-success rounded-pill px-2 px-sm-4 green-btn border-0 ml-2"
                                    data-toggle="modal" data-target="#edit-city"
                                    onclick="window.location.href='{{route('admin.pages.terms_conditions')}}'"
                            >
                                اعدادات الصفحة
                            </button>
                        </div>
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            <button type="submit"
                                    class="update-city btn btn-success rounded-pill px-2 px-sm-4 green-btn border-0 ml-2"
                                    data-toggle="modal" data-target="#edit-city"
                                    onclick="window.location.href='{{route('admin.pages.amrtidall')}}'"
                            >
                                اعدادات الصفحة
                            </button>
                        </div>
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            <button type="submit"
                                    class="update-city btn btn-success rounded-pill px-2 px-sm-4 green-btn border-0 ml-2"
                                    data-toggle="modal" data-target="#edit-city"
                                    onclick="window.location.href='{{route('admin.pages.social')}}'"
                            >
                                اعدادات الصفحة
                            </button>
                        </div>
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            <button type="submit"
                                    class="update-city btn btn-success rounded-pill px-2 px-sm-4 green-btn border-0 ml-2"
                                    data-toggle="modal" data-target="#edit-city"
                                    onclick="window.location.href='{{route('admin.pages.knowUs')}}'"
                            >
                                اعدادات الصفحة
                            </button>
                        </div>
