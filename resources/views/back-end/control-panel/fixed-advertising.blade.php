                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <button type="button"
                                                ...
                                                onclick="window.location.href='{{route('admin.advertise', $row ->advertising->id)}}'">
                                            تفاصيل الاعلان
                                        </button>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <button type="button"
                                                class="btn btn-success rounded-pill px-2 px-sm-4 green-btn border-0 ml-2"
                                                data-toggle="modal" type="button"
                                                onclick="window.location.href='{{route('admin.advertise', $rows_accept ->advertising->id)}}'">
                                            تفاصيل الاعلان
                                        </button>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <button type="button"
                                                class="btn btn-success rounded-pill px-2 px-sm-4 green-btn border-0 ml-2"
                                                data-toggle="modal" type="button"
                                                onclick="window.location.href='{{route('admin.advertise', $rows_refuse ->advertising->id)}}'">
                                            تفاصيل الاعلان
                                        </button>
                                    </div>
                                </td>
