...
@section('content')
    ...
    <section class="container my-5">
            ...
            <div class="content col-12 d-flex justify-content-between align-items-center my-5">
                ...
                <div class="d-flex flex-column">
                    <button type="button" class="btn btn-secondary the-button my-1 px-4"
                            onclick="window.location.href='{{route('moderator.advertising.new.update')}}'"> تحديث
                        الاعلانات
                    </button>
                </div>
            </div>
        ...
        <div class="row">
            <form class="w-100 mx-auto mb-4 mb-md-0" action="{{route('moderator.search.advertising')}}">
                @csrf
                <div
                        ...
                        @foreach($rows as $row)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button
                                        onclick="window.location.href='{{route('moderator.advertising.mainFixed', $row ->id)}}'"
                                        class="btn btn-outline-dark rounded-pill px-2 px-sm-4 border-0 ml-2">
                                        المثبتة
                                    </button>
                                    <button
                                        onclick="window.location.href='{{route('moderator.advertising.accept', $row ->id)}}'"
                                        class="btn btn-outline-dark rounded-pill px-2 px-sm-4 border-0 ml-2">
                                        المفعلة
                                    </button>
                                    <button
                                        onclick="window.location.href='{{route('moderator.advertising.finish', $row ->id)}}'"
                                        class="btn btn-outline-dark rounded-pill px-2 px-sm-4 border-0 ml-2">
                                        منتهية
                                    </button>
                                    <button
                                        onclick="window.location.href='{{route('moderator.advertising.all', $row ->id)}}'"
                                        class="btn btn-outline-dark rounded-pill px-2 px-sm-4 border-0 ml-2">
                                        الكل
                                    </button>
                                </td>
