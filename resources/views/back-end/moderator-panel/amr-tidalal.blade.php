        ...
        <div class="row justify-content-center">
            <div class="content col-12 d-flex justify-content-between align-items-center my-5">
                ...
                <div class="d-flex flex-column">
                    ...
                    <button type="button" onclick="window.location.href='{{route('moderator.amrtidall.pdf')}}'"
                                ...
                                <td>
                                    ...
                                    <div>
                                        <button type="button" class=" btn btn-warning rounded-pill px-2 px-sm-4"
                                                onclick="window.location.href='{{route('moderator.points.active',$point -> id)}}'">
                                            {{$point -> getActive()}}
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class=" modal-body mx-auto edit-modal-content"
                          action="{{route('moderator.amrtidall.update')}}"
                          method="POST">
                        @csrf
    ...
    <div class="modal fade" id="AddModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class=" modal-body mx-auto edit-modal-content" action="{{route('moderator.amrtidall.store')}}"
                          method="POST">
                        @csrf
                        <div class="col-12 my-2">
