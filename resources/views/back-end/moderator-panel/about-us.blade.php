            ...
            <div class="modal-content px-4">
                ...
                <div class="modal-body">
                    <form style="
                      padding-right: 10px;
                      padding-left: 10px;
                " class="contain-form first-form pt-3 modal-content" action="{{route('moderator.pages.store')}}"
                          method="POST">
                        @csrf
                            ...
                            <div class="row ">
                                <div class="form-group row">
                                    ...
                                    <textarea style="width: 100%;height: 200px" name="content"
                                              class="form-control input" id="content"></textarea>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered w-100" role="document">
            <div class="modal-content px-4">
                ...
                <form style="
                      padding-right: 10px;
                      padding-left: 10px;
                " class="contain-form first-form pt-3 modal-content" action="{{route('moderator.pages.update')}}"
                      method="POST">
                    @csrf
                    <input type="hidden" name="page_name" id="page_name" value="{{$page_name}}">
                    <input type="hidden" name="title" id="title" value="{{$title}}">
                        ...
                        <div class="row ">
                            <div class="form-group row">
                                <label style="
                                       ...
                                       height: 50px;
                                      ">النص (أقصى عدد للحروف مسموح بإضافته 450):</label>
                                <textarea style="width:100%;height: 200px" name="content1" class="form-control input"
        ...
        <script>
            ...
            function deleteAlert($id) {
                ...
                swal({
                    ...
                    fetch('/moderator/pages/delete/' + $id)
