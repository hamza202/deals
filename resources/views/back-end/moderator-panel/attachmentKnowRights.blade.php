            ...
            <table class="table table-striped table-hover text-center">
                ...
                @isset($datas)
                    @foreach($datas as $data)
                        <tr>
                            <td>{{$data->name}}</td>
                            <td><a href="{{$data->url}}" download="file"><i class="fa fa-download"
    ...
    <div class="modal fade" id="add-city" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered w-75" role="document">
            ...
            <div class="modal-content">
                ...
                <form class="form" action="{{route('moderator.attachmentKnowRights.store')}}" method="POST"
        ...
        <script>
            ...
            function deleteAlert($id) {
                swal({
                    ...
                    fetch('/moderator/attachmentKnowRights/delete/' + $id)
