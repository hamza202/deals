        ...
        <div class="modal-dialog modal-dialog-centered w-75" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" action="{{route('moderator.packages.store')}}" method="POST"
    ...
    <div class="modal fade" id="edit-city" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered w-75" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" action="{{route('moderator.packages.update')}}" method="POST">
                        @csrf
        ...
        <script>
            ...
            function deleteAlert($id) {
                swal({
                    ...
                    fetch('/moderator/packages/delete/' + $id)
