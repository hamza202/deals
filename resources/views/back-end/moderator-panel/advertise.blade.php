    ...
    <section class="container my-5">
        <div id="accordion">
            ...
            <div>
                ...
                <!-- table -->
                <div class="table-responsive mt-5">
                    <form class="form" action="{{route('moderator.advertise.save_status')}}" method="POST"
            ...
            @if(App\Models\FixedAdvertising::where(['advertising_id' =>$rows -> id ,
                ...
                <div>
                    ...
                    <!-- table -->
                    <div class="table-responsive mt-5">
                        <form class="form" action="{{route('moderator.advertise.save_status_refuse')}}" method="POST"
                              enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id" id="id" value="{{$rows -> id}}">
                            <div class="row modal-body mx-auto edit-modal-content">
