...
@section('content')
    ...
    <section id="main" class="mt-5 container">
        ...
        <div class="row">
            <form class="w-100 mx-auto mb-4 mb-md-0" method="POST" action="{{route('moderator.replace_gifts')}}">
                @csrf
                <div
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <button type="submit"
                                                ...
                                                onclick="window.location.href='{{route('moderator.replace_gifts.update' , $row -> id)}}'">
                                            تأكيد
                                        </button>
            ...
            <div class="modal-dialog modal-dialog-centered w-75" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form" action="{{route('moderator.replace_gifts.updateNotAccept')}}" method="POST">
                            @csrf
