...
class AttachmentKnowRightsController extends Controller
{
    public function index()
    {
        ...
        return view('back-end.control-panel.attachmentKnowRights', compact('datas'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('admin.attachmentKnowRights')->with(['success' => 'تم حفظ المرفق بنجاح']);
        } catch (\Exception $ex) {
            dd($ex);
            return redirect()->route('admin.attachmentKnowRights')->with(['error' => 'هناك خطا ما يرجي المحاوله فيما بعد']);
        }
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->route('admin.attachmentKnowRight')->with(['error' => 'هناك خطا ما يرجي المحاوله فيما بعد']);
        }
    }
